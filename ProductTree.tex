...
\usepackage[paperwidth=30.6cm,paperheight=91.95cm,
...
\node (s3daemon) [pbox,right=15mm of 3-prompt] {\textbf{s3daemon} };
...
\node (1-DAL) [gbox,below=496pt of 1-DA] {\textbf{Chile \&  LHN} };
...
\node (OODS) [pbox,below=4pt of 3-Rucio] {\textbf{OODS} };
\node [below right] at (OODS.north west) {\small \color{blue}Product} ;
 \draw[pline] (2-Curation.east) -| ++(0.4,0) |- (OODS.west); 
\node (2-Infra) [tbox,below=250pt of 2-Curation] {\textbf{Infrastructures} };
...
\node (1-DMSCI) [gbox,below=578pt of 1-DF] {\textbf{DM Science} };
...
\node (2-VnV) [tbox,below=4pt of 2-SciPip] {\textbf{V\& V} };
...
\node (1-DS) [gbox,below=168pt of 1-DP] {\textbf{Data Services} };
