...
\usepackage[paperwidth=102.30000000000001cm,paperheight=12.24cm,
...
\node (CHATBOT) [pbox,] {\textbf{Chatbots} };
...
\node (PandaIF) [pbox,right=31mm of TIMESI] {\textbf{Panda IF} };
\node [below right] at (PandaIF.north west) {\small \color{blue}Data Abstraction} ;
\node (CC) [pbox,right=15mm of PandaIF] {\textbf{Com. Cluster} };
...
\node (DM) [wbbox, above=15mm of MW]{\textbf{DMops}};
