...
Security is ia NOIRLab responsability an estimation of it is in \cite{RTN-030}.
...
Urgent decisions can be taken offline, outside the weekly meeting, in a modality to be defined by the DMCCB itself (currently Slack channel).
...
\subsection{Work Breakdown Structure and Milestones} \label{sec:wbs}

Table \tabref{tab:openMilestones} gives the open milestones  for DM in operations.
